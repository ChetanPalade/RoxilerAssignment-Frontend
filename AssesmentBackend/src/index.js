...
const initializeDbAndServer = async () => {
  try {
    ...
    app.listen(3000,() => 
      console.log(`Database connection established successfully ${port}!`)
    )
  } catch (e) {
...
const transaction = new express.Schema({
...
const Transaction = express.model('Transaction', transaction);
